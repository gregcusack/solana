...
impl Node {
    ...
    pub fn new_single_bind(
        ...
        let (tvu_quic_port, tvu_quic) =
            Self::bind_with_config(bind_ip_addr, port_range, read_write_socket_config.clone());
        let tpu_udp_config = SocketConfig::default().usage(SocketUsage::ReadOnly);
        ...
        let tpu_forwards_udp_config = SocketConfig::default().usage(SocketUsage::ReadOnly);
        let tpu_forwards_quic_config = SocketConfig::default()
            .reuseport(true)
            .usage(SocketUsage::ReadOnly);
        ...
        let tpu_vote_udp_config = SocketConfig::default().usage(SocketUsage::ReadOnly);
        let tpu_vote_quic_config = SocketConfig::default()
            .reuseport(true)
            .usage(SocketUsage::ReadOnly);
        ...
        let write_only_socket_config = SocketConfig::default().usage(SocketUsage::WriteOnly);
    ...
    pub fn new_with_external_ip(pubkey: &Pubkey, config: NodeConfig) -> Node {
        ...
        let tpu_config = SocketConfig::default()
            .reuseport(true)
            .usage(SocketUsage::ReadOnly);
