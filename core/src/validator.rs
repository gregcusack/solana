...
impl Validator {
    ...
    pub fn new_with_exit(
        ...
        *start_progress.write().unwrap() = ValidatorStartProgress::StartingServices;
        ...
        let (votor_egress, votor_ingress, votor_banlist, votor_allowlist) = if let Some(socket) =
            alpenglow_socket
        {
            ...
            let endpoint = agave_votor::datagram_transport::endpoint::QuicDatagramEndpoint::new(
                votor_rt_handle,
                &identity_keypair,
                socket,
