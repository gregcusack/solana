...
pub struct AlpenglowInitializationState {
    ...
    pub votor_egress:
        tokio::sync::mpsc::Sender<agave_votor::datagram_transport::endpoint::Datagram>,
    pub votor_ingress: Receiver<Datagram>,
    pub votor_banlist: Arc<Banlist<Pubkey>>,
    pub votor_allowlist:
        Option<Arc<agave_votor::datagram_transport::allowlist::StakedNodesAllowlist>>,
...
impl Tvu {
    ...
    pub fn new(
        ...
        // BLS sigverifier — fed by the votor datagram endpoint constructed
        ...
        // constructed and ingress will simply never fire. The `_` on
        // bls_socket below is intentional — we don't actually need it
        // here anymore (validator.rs already consumed it).
        let _ = bls_socket;
        let bls_sigverify_threads = {
            ...
            let bls_sigverifier_t = bls_sigverifier::spawn_service(
                ...
                SigVerifierContext {
                    ...
                    banlist: SigVerifierBanlist::Datagram(votor_banlist),
                    sharable_banks,
                ...
                SigVerifierChannels {
                    packet_receiver: SigVerifierPacketReceiver::Datagram(votor_ingress),
