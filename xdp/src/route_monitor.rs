use {
    ...
    libc::{
        ...
        RTM_DELNEIGH, RTM_DELROUTE, RTM_NEWNEIGH, RTM_NEWROUTE, RTM_DELLINK, RTM_NEWLINK, RTMGRP_LINK,
    },
    log::*,
        std::{
        io::{Error, ErrorKind},
...
impl RouteMonitor {
    pub fn start(atomic_router: Arc<AtomicRouter>, _exit: Arc<AtomicBool>, _update_interval: Duration) -> thread::JoinHandle<()> {
