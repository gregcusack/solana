    ...
    App::new("solana-test-validator")
        ...
        .arg(
            Arg::with_name("bind_address")
                ...
                .help(
                    "IPv4 address to bind the validator ports. ALL protocols (gossip, repair, IP \
                     echo, TVU, TPU, etc.) bind to this address on startup.",
                ),
        )
        .arg(
            Arg::with_name("advertised_ip")
                ...
                .help(
                    "Use when running a validator behind a NAT. DNS name or IP address for this \
                     ...
                     --bind-address value, or ask --entrypoint when --bind-address is not \
                     provided, or 127.0.0.1 when --entrypoint is not provided].",
                ),
        )
        .arg(
