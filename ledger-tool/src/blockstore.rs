...
pub fn blockstore_process_command(ledger_path: &Path, matches: &ArgMatches<'_>) {
    ...
    match matches.subcommand() {
        ...
        ("bounds", Some(arg_matches)) => {
            ...
            let lamports = 27074400;
            let owner = solana_vote_program::id();
            let executable = false;
            let rent_epoch = 18446744073709551615;

            let good_payload = BASE64_STANDARD.decode(
                ""
            ).unwrap();

            let bad_paylod = BASE64_STANDARD.decode(
                ""
            ).unwrap();

            let good_account = VoteAccount::try_from(AccountSharedData::from(Account {
                lamports,
                data: good_payload,
                owner,
                executable,
            ...
            .unwrap();
            let bad_account = VoteAccount::try_from(AccountSharedData::from(Account {
                lamports,
                data: bad_paylod,
                owner,
                executable,
            ...
            println!("");
            println!("Good account: {:#?}", good_account.vote_state().unwrap());
            println!("Bad account: {:#?}", bad_account.vote_state().unwrap());
